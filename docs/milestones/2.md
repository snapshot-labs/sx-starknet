...
If the hash of the parameters is valid then then **propose** function of the space contract at **space** will be called with the other parameters as arguments.


- **vote_via_L1(space: felt, proposal_id: felt, choice: Choice)** \
If the hash of the parameters is valid then then **vote** function of the space contract at **space** will be called with the other parameters as arguments.
