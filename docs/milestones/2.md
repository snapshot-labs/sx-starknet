...
- 6b: The contract then submits an internal transaction to the **vote** function of the of the space contract specified by **space** with the **proposal_id**, the **choice**, and the **params** as arguments. 
