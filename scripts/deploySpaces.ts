...
async function main() {
  ...
  const votingStrategyParamsFlat2 = utils.encoding.flatten2DArray(votingStrategyParams1);
  ...
  const votingStrategyParamsFlat3 = utils.encoding.flatten2DArray(votingStrategyParams1);
