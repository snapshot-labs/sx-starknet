...
#[starknet::interface]
trait IStarkSigSessionKeyAuthenticator<TContractState> {
...
#[starknet::contract]
mod StarkSigSessionKeyAuthenticator {
    ...
    #[external(v0)]
    impl StarkSigSessionKeyAuthenticator of IStarkSigSessionKeyAuthenticator<ContractState> {
        fn authenticate_propose(
        ...
        fn register_with_owner_sig(
            ...
            let mut state = SessionKey::unsafe_new_contract_state();
            SessionKey::InternalImpl::register_with_owner_stark_sig(
                ref state, signature, owner, session_public_key, session_duration, salt
            );
        }
        ...
        fn revoke_with_owner_sig(
            ...
            let mut state = SessionKey::unsafe_new_contract_state();
            SessionKey::InternalImpl::revoke_with_owner_stark_sig(
                ref state, signature, owner, session_public_key, salt
            );
        }
