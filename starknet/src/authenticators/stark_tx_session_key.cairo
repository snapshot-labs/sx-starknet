...
trait IStarkTxSessionKeyAuthenticator<TContractState> {
    ...
    fn authorize_with_stark_tx(
        ref self: ContractState, session_public_key: felt252, session_duration: u32
    ) {}

    fn revoke_with_owner_stark_tx(ref self: ContractState, session_public_key: felt252) {}
