...
export async function safeWithZodiacSetup2(
  starknetCoreAddress = '0x0000000000000000000000000000000000000001',
  spaceAddress = BigInt(1),
  zodiacRelayerAddress = BigInt(1)
) {
  const wallets = await ethers.getSigners();
  const safeSigner = wallets[0]; // One 1 signer on the safe
  ...
  const SnapshotXContract = await ethers.getContractFactory('SXAvatarExecutor');
